...
## Summary
Implement the main family tree screen and navigation model.

## User Story
As a user, I want to tree screen so that I can successfully use the KinVerse experience.

## Description
This issue covers the implementation of tree screen within the Family Tree epic. The work should include the full user flow, validation, and backend/frontend integration required for a production-ready experience.
