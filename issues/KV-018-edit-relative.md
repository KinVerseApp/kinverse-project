# KV-018 - Edit Relative

## Epic
Relationships

## Summary
Allow updates to a relative?s details after initial creation.

## User Story
As a user, I want to edit relative so that I can successfully use the KinVerse experience.

## Description
This issue covers the implementation of edit relative within the Relationships epic. The work should include the full user flow, validation, and backend/frontend integration required for a production-ready experience.
