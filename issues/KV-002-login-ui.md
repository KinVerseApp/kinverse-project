...
## Summary
Create the sign-in experience with email/password entry and error states.

## User Story
As a user, I want to login ui so that I can successfully use the KinVerse experience.

## Description
This issue covers the implementation of login ui within the Authentication epic. The work should include the full user flow, validation, and backend/frontend integration required for a production-ready experience.
