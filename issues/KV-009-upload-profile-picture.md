# KV-009 - Upload Profile Picture

## Epic
Profile

## Summary
Let users upload, preview, and store a profile photo.

## User Story
As a user, I want to upload profile picture so that I can successfully use the KinVerse experience.

## Description
This issue covers the implementation of upload profile picture within the Profile epic. The work should include the full user flow, validation, and backend/frontend integration required for a production-ready experience.
