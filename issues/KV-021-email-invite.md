...
## Summary
Send invite emails to family members to join the app.

## User Story
As a user, I want to email invite so that I can successfully use the KinVerse experience.

## Description
This issue covers the implementation of email invite within the Invitations epic. The work should include the full user flow, validation, and backend/frontend integration required for a production-ready experience.
